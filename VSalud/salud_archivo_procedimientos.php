...
include_once("Configuraciones/salud_archivo_procedimientos.ini.php");  //Clases de donde se escribirán las tablas
...
$statement=$obTabla->FiltroRangoFechas("fecha_procedimiento", $statement, "");
$Vector["statement"]=$statement;   //Filtro necesario para la paginacion
...
///////////////Creamos la imagen representativa de la pagina
    /////
    /////	
$css->CrearImageLink("../VMenu/MnuInventarios.php", "../images/ap.jpg", "_self",100,100);
