<?php
$myPage="salud_archivo_hospitalizaciones.php";
...
include_once("Configuraciones/salud_archivo_hospitalizaciones.ini.php");  //Clases de donde se escribirán las tablas
...
$statement=$obTabla->FiltroRangoFechas("fecha_ingreso_hospi", $statement, "");
$Vector["statement"]=$statement;   //Filtro necesario para la paginacion
...
///////////////Creamos la imagen representativa de la pagina
    /////
    /////	
$css->CrearImageLink("../VMenu/MnuInventarios.php", "../images/ah.png", "_self",100,100);
