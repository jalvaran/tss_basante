...
include_once("Configuraciones/salud_archivo_consultas.ini.php");  //Clases de donde se escribirán las tablas
...
$statement=$obTabla->FiltroRangoFechas("fecha_consulta", $statement, "");
$Vector["statement"]=$statement;   //Filtro necesario para la paginacion
...
///////////////Creamos la imagen representativa de la pagina
    /////
    /////	
$css->CrearImageLink("../VMenu/MnuInventarios.php", "../images/ac.png", "_self",100,100);
